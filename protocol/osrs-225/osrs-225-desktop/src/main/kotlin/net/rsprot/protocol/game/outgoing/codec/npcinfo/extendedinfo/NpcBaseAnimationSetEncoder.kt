...
public class NpcBaseAnimationSetEncoder : PrecomputedExtendedInfoEncoder<BaseAnimationSet> {
    override fun precompute(
        ...
        if (flag and 0x1 != 0) {
            buffer.p2Alt1(extendedInfo.turnLeftAnim.toInt())
        }
        if (flag and 0x2 != 0) {
            buffer.p2Alt3(extendedInfo.turnRightAnim.toInt())
        }
        if (flag and 0x4 != 0) {
            buffer.p2Alt2(extendedInfo.walkAnim.toInt())
        }
        if (flag and 0x8 != 0) {
        ...
        if (flag and 0x20 != 0) {
            buffer.p2Alt1(extendedInfo.walkAnimRight.toInt())
        }
        if (flag and 0x40 != 0) {
        ...
        if (flag and 0x800 != 0) {
            buffer.p2Alt1(extendedInfo.crawlAnimBack.toInt())
        }
