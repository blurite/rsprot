...
public class NpcInfoProtocol(
	...
	private val resolutionChangeEncoders: net.rsprot.protocol.internal.client.ClientTypeMap<net.rsprot.protocol.internal.game.outgoing.info.npcinfo.encoder.NpcResolutionChangeEncoder>,
