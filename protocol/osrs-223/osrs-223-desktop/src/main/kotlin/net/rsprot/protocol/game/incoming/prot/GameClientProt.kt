...
import net.rsprot.protocol.Prot.Companion.VAR_BYTE
import net.rsprot.protocol.Prot.Companion.VAR_SHORT
...
public enum class GameClientProt(
    ...
    EVENT_KEYBOARD(GameClientProtId.EVENT_KEYBOARD, VAR_SHORT),
    EVENT_MOUSE_SCROLL(GameClientProtId.EVENT_MOUSE_SCROLL, 2),
    EVENT_MOUSE_MOVE(GameClientProtId.EVENT_MOUSE_MOVE, VAR_BYTE),
    EVENT_NATIVE_MOUSE_MOVE(GameClientProtId.EVENT_NATIVE_MOUSE_MOVE, VAR_BYTE),
    ...
    RESUME_P_NAMEDIALOG(GameClientProtId.RESUME_P_NAMEDIALOG, VAR_BYTE),
    RESUME_P_STRINGDIALOG(GameClientProtId.RESUME_P_STRINGDIALOG, VAR_BYTE),
    RESUME_P_COUNTDIALOG(GameClientProtId.RESUME_P_COUNTDIALOG, 4),
    RESUME_P_OBJDIALOG(GameClientProtId.RESUME_P_OBJDIALOG, 2),

    // Friend chat packets
    FRIENDCHAT_KICK(GameClientProtId.FRIENDCHAT_KICK, VAR_BYTE),
    FRIENDCHAT_SETRANK(GameClientProtId.FRIENDCHAT_SETRANK, VAR_BYTE),
    FRIENDCHAT_JOIN_LEAVE(GameClientProtId.FRIENDCHAT_JOIN_LEAVE, VAR_BYTE),
    ...
    CLANCHANNEL_KICKUSER(GameClientProtId.CLANCHANNEL_KICKUSER, VAR_BYTE),
    AFFINEDCLANSETTINGS_ADDBANNED_FROMCHANNEL(GameClientProtId.AFFINEDCLANSETTINGS_ADDBANNED_FROMCHANNEL, VAR_BYTE),
    AFFINEDCLANSETTINGS_SETMUTED_FROMCHANNEL(GameClientProtId.AFFINEDCLANSETTINGS_SETMUTED_FROMCHANNEL, VAR_BYTE),

    // Socials
    FRIENDLIST_ADD(GameClientProtId.FRIENDLIST_ADD, VAR_BYTE),
    FRIENDLIST_DEL(GameClientProtId.FRIENDLIST_DEL, VAR_BYTE),
    IGNORELIST_ADD(GameClientProtId.IGNORELIST_ADD, VAR_BYTE),
    IGNORELIST_DEL(GameClientProtId.IGNORELIST_DEL, VAR_BYTE),

    // Messaging
    MESSAGE_PUBLIC(GameClientProtId.MESSAGE_PUBLIC, VAR_BYTE),
    MESSAGE_PRIVATE(GameClientProtId.MESSAGE_PRIVATE, VAR_SHORT),

    // Misc. user packets
    MOVE_GAMECLICK(GameClientProtId.MOVE_GAMECLICK, VAR_BYTE),
    MOVE_MINIMAPCLICK(GameClientProtId.MOVE_MINIMAPCLICK, VAR_BYTE),
    CLIENT_CHEAT(GameClientProtId.CLIENT_CHEAT, VAR_BYTE),
    ...
    BUG_REPORT(GameClientProtId.BUG_REPORT, VAR_SHORT),
    SEND_SNAPSHOT(GameClientProtId.SEND_SNAPSHOT, VAR_BYTE),
    HISCORE_REQUEST(GameClientProtId.HISCORE_REQUEST, VAR_BYTE),
    IF_CRMVIEW_CLICK(GameClientProtId.IF_CRMVIEW_CLICK, 22),
    UPDATE_PLAYER_MODEL(GameClientProtId.UPDATE_PLAYER_MODEL, 13),

    // Misc. client packets
    TIMINGS(GameClientProtId.TIMINGS, VAR_BYTE),
    SEND_PING_REPLY(GameClientProtId.SEND_PING_REPLY, 10),
    DETECT_MODIFIED_CLIENT(GameClientProtId.DETECT_MODIFIED_CLIENT, 4),
    REFLECTION_CHECK_REPLY(GameClientProtId.REFLECTION_CHECK_REPLY, VAR_BYTE),
