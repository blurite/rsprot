package net.rsprot.protocol.game.incoming.worldentities
...
/**
 * OpWorldEntityT messages are fired whenever an interface component is targeted
 * on a world entity, which, as of revision 204, includes using items from
 * the player's inventory on World Entities - the OpWorldEntityU message was deprecated.
 * @property index the index of the worldentity the component was used on
 ...
 * @property selectedComponentId the component id being used on the worldentity
...
public class OpWorldEntityT private constructor(
