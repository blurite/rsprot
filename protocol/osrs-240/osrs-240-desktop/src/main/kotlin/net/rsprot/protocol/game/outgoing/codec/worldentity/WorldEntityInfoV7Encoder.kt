...
public class WorldEntityInfoV7Encoder : MessageEncoder<WorldEntityInfoV7Packet> {
    override val prot: ServerProt = GameServerProt.WORLDENTITY_INFO_V7

    override fun encode(
        streamCipher: StreamCipher,
        buffer: JagByteBuf,
        message: WorldEntityInfoV7Packet,
    ) {
