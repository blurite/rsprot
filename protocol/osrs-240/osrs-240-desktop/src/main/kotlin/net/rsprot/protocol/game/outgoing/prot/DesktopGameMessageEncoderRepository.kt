...
import net.rsprot.protocol.game.outgoing.codec.group.GroupVarIntEncoder
import net.rsprot.protocol.game.outgoing.codec.group.GroupVarLongEncoder
...
import net.rsprot.protocol.game.outgoing.codec.sound.AmbientSoundStartEncoder
import net.rsprot.protocol.game.outgoing.codec.sound.AmbientSoundStopEncoder
...
import net.rsprot.protocol.game.outgoing.codec.worldentity.WorldEntityInfoV7Encoder
    ...
    public fun build(huffmanCodecProvider: HuffmanCodecProvider): MessageEncoderRepository<GameServerProt> {
        ...
        val builder =
            MessageEncoderRepositoryBuilder(
                ...
                bind(AmbientSoundStartEncoder())
                bind(AmbientSoundStopEncoder())
                ...
                bind(GroupVarIntEncoder())
                bind(GroupVarLongEncoder())
