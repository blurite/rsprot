...
public class NameChange(
    encoders: Array<PrecomputedExtendedInfoEncoder<NameChange>?> = arrayOfNulls(PlatformType.COUNT),
    private val allocator: ByteBufAllocator,
    private val huffmanCodec: HuffmanCodec,
) : TransientExtendedInfo<NameChange, PrecomputedExtendedInfoEncoder<NameChange>>(encoders) {
