...
public class BodyCustomisation(
    encoders: Array<PrecomputedExtendedInfoEncoder<BodyCustomisation>?> = arrayOfNulls(PlatformType.COUNT),
    private val allocator: ByteBufAllocator,
    private val huffmanCodec: HuffmanCodec,
) : TransientExtendedInfo<BodyCustomisation, PrecomputedExtendedInfoEncoder<BodyCustomisation>>(encoders) {
