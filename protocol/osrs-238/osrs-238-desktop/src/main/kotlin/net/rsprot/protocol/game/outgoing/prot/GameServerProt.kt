...
public enum class GameServerProt(
    ...
    IF_SETMODEL_V2(GameServerProtId.IF_SETMODEL_V2, 8),
    ...
    AMBIENTSOUND_START(GameServerProtId.AMBIENTSOUND_START, 3),
    AMBIENTSOUND_STOP(GameServerProtId.AMBIENTSOUND_STOP, 1),
    ...
    // Map packets
    REBUILD_NORMAL_V2(GameServerProtId.REBUILD_NORMAL_V2, Prot.VAR_SHORT),
    REBUILD_REGION_V2(GameServerProtId.REBUILD_REGION_V2, Prot.VAR_SHORT),
    REBUILD_WORLDENTITY_V4(GameServerProtId.REBUILD_WORLDENTITY_V4, Prot.VAR_SHORT),
