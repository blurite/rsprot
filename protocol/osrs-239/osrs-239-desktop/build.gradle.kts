...
dependencies {
    ...
    api(projects.protocol.osrs239.osrs239Internal)
...
mavenPublishing {
    pom {
        name = "RsProt OSRS 239 Desktop"
        description = "The desktop module for revision 239 OldSchool RuneScape networking, " +
