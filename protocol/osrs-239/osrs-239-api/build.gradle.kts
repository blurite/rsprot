dependencies {
    ...
    api(projects.crypto)
    api(projects.protocol.osrs239.osrs239Common)
    api(projects.protocol.osrs239.osrs239Model)
    implementation(projects.protocol.osrs239.osrs239Internal)
    implementation(projects.protocol.osrs239.osrs239Desktop)
    implementation(projects.protocol.osrs239.osrs239Shared)
    implementation(projects.buffer)
}

mavenPublishing {
    pom {
        name = "RsProt OSRS 239 API"
        description = "The API module for revision 239 OldSchool RuneScape networking, " +
