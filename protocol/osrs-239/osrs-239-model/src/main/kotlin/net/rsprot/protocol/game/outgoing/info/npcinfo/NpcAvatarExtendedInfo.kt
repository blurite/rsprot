...
public class NpcAvatarExtendedInfo(
    ...
    /**
     * Sets the transparency override on the NPC. The transparency value is linearly interpolated
     ...
     * @param endTime the ending timestamp when the current transparency value on the NPC
    ...
    internal fun getLowToHighResChangeExtendedInfoFlags(): Int {
        ...
        if (this.flags and FACE == 0 && blocks.face.hasPersistentTarget()) {
            flag = flag or FACE
        }
    ...
    public companion object {
        ...
        public const val FACE: Int = 0x40
        ...
        public const val TRANSPARENCY: Int = 0x40000
