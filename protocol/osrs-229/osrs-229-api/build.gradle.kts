dependencies {
    ...
    implementation(projects.protocol.osrs229.osrs229Internal)
    implementation(projects.protocol.osrs229.osrs229Desktop)
    implementation(projects.protocol.osrs229.osrs229Shared)
    implementation(projects.buffer)
}

mavenPublishing {
    pom {
        name = "RsProt OSRS 229 API"
        description = "The API module for revision 229 OldSchool RuneScape networking, " +
