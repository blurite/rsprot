...
public class PlayerExactMoveEncoder : PrecomputedExtendedInfoEncoder<net.rsprot.protocol.internal.game.outgoing.info.shared.extendedinfo.ExactMove> {
    override fun precompute(
        ...
        val buffer =
            alloc
                .buffer(10, 10)
                .toJagByteBuf()
        buffer.p1(extendedInfo.deltaX1.toInt())
        buffer.p1Alt2(extendedInfo.deltaZ1.toInt())
        ...
        buffer.p2Alt2(extendedInfo.direction.toInt())
        return buffer
    }
}
