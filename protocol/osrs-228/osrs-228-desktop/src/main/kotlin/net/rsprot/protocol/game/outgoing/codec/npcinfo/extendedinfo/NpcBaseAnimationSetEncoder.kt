...
public class NpcBaseAnimationSetEncoder : PrecomputedExtendedInfoEncoder<BaseAnimationSet> {
    override fun precompute(
        ...
        if (flag and 0x2 != 0) {
            buffer.p2Alt2(extendedInfo.turnRightAnim.toInt())
        }
        if (flag and 0x4 != 0) {
            buffer.p2Alt3(extendedInfo.walkAnim.toInt())
        }
        if (flag and 0x8 != 0) {
            buffer.p2Alt3(extendedInfo.walkAnimBack.toInt())
        }
        if (flag and 0x10 != 0) {
            buffer.p2Alt3(extendedInfo.walkAnimLeft.toInt())
        }
        if (flag and 0x20 != 0) {
            buffer.p2(extendedInfo.walkAnimRight.toInt())
        }
        if (flag and 0x40 != 0) {
            buffer.p2Alt1(extendedInfo.runAnim.toInt())
        }
        if (flag and 0x80 != 0) {
            buffer.p2Alt3(extendedInfo.runAnimBack.toInt())
        }
        if (flag and 0x100 != 0) {
            buffer.p2(extendedInfo.runAnimLeft.toInt())
        }
        if (flag and 0x200 != 0) {
            buffer.p2Alt2(extendedInfo.runAnimRight.toInt())
        }
        if (flag and 0x400 != 0) {
            buffer.p2(extendedInfo.crawlAnim.toInt())
        }
        if (flag and 0x800 != 0) {
        ...
        if (flag and 0x2000 != 0) {
            buffer.p2(extendedInfo.crawlAnimRight.toInt())
        }
        if (flag and 0x4000 != 0) {
            buffer.p2Alt1(extendedInfo.readyAnim.toInt())
        }
        return buffer
    }
}
