 ...
 */
public abstract class TransientExtendedInfo<in T : net.rsprot.protocol.internal.game.outgoing.info.ExtendedInfo<T, E>, E : net.rsprot.protocol.internal.game.outgoing.info.encoder.ExtendedInfoEncoder<T>> :
