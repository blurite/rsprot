...
import net.rsprot.protocol.game.outgoing.codec.playerinfo.extendedinfo.NpcBaseAnimationSetEncoder
import net.rsprot.protocol.game.outgoing.codec.playerinfo.extendedinfo.NpcBodyCustomisationEncoder
import net.rsprot.protocol.game.outgoing.codec.playerinfo.extendedinfo.NpcCombatLevelChangeEncoder
import net.rsprot.protocol.game.outgoing.codec.playerinfo.extendedinfo.NpcExactMoveEncoder
import net.rsprot.protocol.game.outgoing.codec.playerinfo.extendedinfo.NpcFaceCoordEncoder
import net.rsprot.protocol.game.outgoing.codec.playerinfo.extendedinfo.NpcFacePathingEntityEncoder
import net.rsprot.protocol.game.outgoing.codec.playerinfo.extendedinfo.NpcHeadCustomisationEncoder
import net.rsprot.protocol.game.outgoing.codec.playerinfo.extendedinfo.NpcHeadIconCustomisationEncoder
import net.rsprot.protocol.game.outgoing.codec.playerinfo.extendedinfo.NpcHitEncoder
import net.rsprot.protocol.game.outgoing.codec.playerinfo.extendedinfo.NpcNameChangeEncoder
import net.rsprot.protocol.game.outgoing.codec.playerinfo.extendedinfo.NpcSayEncoder
import net.rsprot.protocol.game.outgoing.codec.playerinfo.extendedinfo.NpcSequenceEncoder
import net.rsprot.protocol.game.outgoing.codec.playerinfo.extendedinfo.NpcSpotAnimEncoder
import net.rsprot.protocol.game.outgoing.codec.playerinfo.extendedinfo.NpcTintingEncoder
import net.rsprot.protocol.game.outgoing.codec.playerinfo.extendedinfo.NpcTransformationEncoder
import net.rsprot.protocol.game.outgoing.codec.playerinfo.extendedinfo.NpcVisibleOpsEncoder
