 ...
 */
@Deprecated(
    message = "Deprecated. Use SetActiveWorldV2.",
    replaceWith = ReplaceWith("SetActiveWorldV2"),
)
public class SetActiveWorldV1(
    ...
    override fun toString(): String = "SetActiveWorldV1(worldType=$worldType)"
