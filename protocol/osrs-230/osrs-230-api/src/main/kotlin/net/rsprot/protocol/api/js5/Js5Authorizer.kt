...
/**
 * An interface to authorize certain [InetAddress]es, and check if they are authorized
...
public interface Js5Authorizer {
     ...
     *
     * @param address the [InetAddress] to authorize.
     */
    public fun authorize(address: InetAddress)
     ...
     * @param address the [InetAddress] to authorize.
     */
    public fun unauthorize(address: InetAddress)

    /**
     * Checks if a cache archive is authorized for the specified [InetAddress].
     *
     * @param address the [InetAddress] to check for authorization.
