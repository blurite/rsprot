dependencies {
    ...
    implementation(projects.protocol.osrs230.osrs230Internal)
    implementation(projects.protocol.osrs230.osrs230Desktop)
    implementation(projects.protocol.osrs230.osrs230Shared)
    implementation(projects.buffer)
}

mavenPublishing {
    pom {
        name = "RsProt OSRS 230 API"
        description = "The API module for revision 230 OldSchool RuneScape networking, " +
