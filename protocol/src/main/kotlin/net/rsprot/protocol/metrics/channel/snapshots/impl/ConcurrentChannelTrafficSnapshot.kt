 ...
 * such as the number of active connections from each [String] at the time of capturing
 ...
 * organized per [String].
 * @property hostAddressSnapshots the snapshots per [String], containing any
...
public class ConcurrentChannelTrafficSnapshot<CP, SP, DC>(
    ...
    public val activeConnectionsByAddress: Map<String, Int>,
    public val inetAddressSnapshots: Map<String, InetAddressSnapshot<CP, SP, DC>>,
