dependencies {
    ...
    implementation(projects.protocol.osrs222.osrs222Internal)
    implementation(projects.protocol.osrs222.osrs222Desktop)
    implementation(projects.protocol.osrs222.osrs222Shared)
