...
public enum class GameServerProt(
    ...
    WORLDENTITY_SET_INTERACTION_MODE(GameServerProtId.WORLDENTITY_SET_INTERACTION_MODE, 4),
    WORLDENTITY_RESET_INTERACTION_MODE(GameServerProtId.WORLDENTITY_RESET_INTERACTION_MODE, 2),
