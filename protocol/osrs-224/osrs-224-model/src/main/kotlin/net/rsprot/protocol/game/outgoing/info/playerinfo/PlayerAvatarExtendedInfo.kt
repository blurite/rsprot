...
public class PlayerAvatarExtendedInfo(
    ...
    internal fun getLowToHighResChangeExtendedInfoFlags(
        ...
        if (this.flags and FACE_ANGLE == 0 &&
            blocks.faceAngle.angle != net.rsprot.protocol.internal.game.outgoing.info.playerinfo.extendedinfo.FaceAngle.DEFAULT_VALUE &&
    ...
    internal fun pExtendedInfo(
        ...
        // Note: The order must be as client expects it, in 224 say is after chat
        if (flag and CHAT != 0) {
