...
internal object GameServerProtId {
    ...
    const val PROJANIM_SPECIFIC_OLD = 12
    ...
    const val NPC_INFO_SMALL = 94
    const val UPDATE_TRADINGPOST = 95
    const val NPC_INFO_LARGE = 96
