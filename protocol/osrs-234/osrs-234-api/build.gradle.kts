dependencies {
    ...
    implementation(projects.protocol.osrs234.osrs234Internal)
    implementation(projects.protocol.osrs234.osrs234Desktop)
    implementation(projects.protocol.osrs234.osrs234Shared)
    implementation(projects.buffer)
}

mavenPublishing {
    pom {
        name = "RsProt OSRS 234 API"
        description = "The API module for revision 234 OldSchool RuneScape networking, " +
