dependencies {
    ...
    implementation(projects.protocol.osrs237.osrs237Internal)
    implementation(projects.protocol.osrs237.osrs237Desktop)
    implementation(projects.protocol.osrs237.osrs237Shared)
    implementation(projects.buffer)
}

mavenPublishing {
    pom {
        name = "RsProt OSRS 237 API"
        description = "The API module for revision 237 OldSchool RuneScape networking, " +
