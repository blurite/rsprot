...
public class WorldEntityInfo internal constructor(
     ...
     */
    internal var previousPacket: WorldEntityInfoV7Packet? = null
     ...
     */
    internal fun toPacketResult(): PacketResult<WorldEntityInfoV7Packet> {
    ...
    internal fun postUpdate() {
        ...
        val packet = WorldEntityInfoV7Packet(backingBuffer())
    ...
    private fun processLowResolution(buffer: JagByteBuf) {
        ...
        for (k in 0..<length) {
            ...
            buffer.p1Alt3(priority.id)
            buffer.p1Alt3((avatar.sizeX shl 4) or avatar.sizeZ)
            val placeholderFlag = buffer.writerIndex()
            buffer.p1Alt3(0) // Placeholder, updated to real value below
