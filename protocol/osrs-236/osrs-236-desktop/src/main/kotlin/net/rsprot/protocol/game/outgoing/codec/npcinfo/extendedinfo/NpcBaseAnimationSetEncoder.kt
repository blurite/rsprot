...
public class NpcBaseAnimationSetEncoder : PrecomputedExtendedInfoEncoder<BaseAnimationSet> {
    override fun precompute(
        ...
        if (flag and 0x1 != 0) {
            buffer.p2Alt2(extendedInfo.turnLeftAnim.toInt())
        }
        if (flag and 0x2 != 0) {
        ...
        if (flag and 0x10 != 0) {
            buffer.p2Alt2(extendedInfo.walkAnimLeft.toInt())
        }
        if (flag and 0x20 != 0) {
            buffer.p2(extendedInfo.walkAnimRight.toInt())
        }
        if (flag and 0x40 != 0) {
            buffer.p2Alt3(extendedInfo.runAnim.toInt())
        }
        if (flag and 0x80 != 0) {
        ...
        if (flag and 0x1000 != 0) {
            buffer.p2Alt2(extendedInfo.crawlAnimLeft.toInt())
        }
