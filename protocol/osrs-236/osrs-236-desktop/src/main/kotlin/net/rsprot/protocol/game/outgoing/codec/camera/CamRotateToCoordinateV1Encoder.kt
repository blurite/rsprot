...
@Consistent
public class CamRotateToCoordinateV1Encoder : MessageEncoder<CamRotateToCoordinateV1> {
    override val prot: ServerProt = GameServerProt.CAM_ROTATETO_COORDINATE_V1

    override fun encode(
        streamCipher: StreamCipher,
        buffer: JagByteBuf,
        message: CamRotateToCoordinateV1,
    ) {
