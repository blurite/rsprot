dependencies {
    ...
    implementation(projects.protocol.osrs233.osrs233Internal)
    implementation(projects.protocol.osrs233.osrs233Desktop)
    implementation(projects.protocol.osrs233.osrs233Shared)
    implementation(projects.buffer)
}

mavenPublishing {
    pom {
        name = "RsProt OSRS 233 API"
        description = "The API module for revision 233 OldSchool RuneScape networking, " +
