...
public class NpcAvatarExtendedInfoBlocks(
    ...
    public val nameChange: net.rsprot.protocol.internal.game.outgoing.info.npcinfo.extendedinfo.NameChange =
	    net.rsprot.protocol.internal.game.outgoing.info.npcinfo.extendedinfo.NameChange(
		    encoders(
			    writers,
			    NEnc::nameChange
		    )
	    )
    public val headCustomisation: net.rsprot.protocol.internal.game.outgoing.info.npcinfo.extendedinfo.HeadCustomisation =
	    net.rsprot.protocol.internal.game.outgoing.info.npcinfo.extendedinfo.HeadCustomisation(
		    encoders(
			    writers,
    ...
    public val transformation: net.rsprot.protocol.internal.game.outgoing.info.npcinfo.extendedinfo.Transformation =
	    net.rsprot.protocol.internal.game.outgoing.info.npcinfo.extendedinfo.Transformation(
		    encoders(
			    writers,
			    NEnc::transformation
		    )
